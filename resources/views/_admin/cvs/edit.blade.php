...
@section('title')
@lang('admin.Edit') @lang('cvs.Cv')  #{{ $cv->id }}
@endsection
@push('css') 
...
@section('content_header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">@lang('admin.Edit') @lang('cvs.Cv')  #{{ $cv->id }}</li>
    </ol>
@endsection
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box-header with-border">
              <h3 class="box-title"> <a href="{{ route('admin.cvs.index') }}" title="Back"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button></a>&nbsp;&nbsp; @lang('admin.Edit') @lang('cvs.Cv') #{{ $cv->id }}</h3>
            </div>
			...
			<div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.cvs.update', $cv->id) }}" data-edit="true" accept-charset="UTF-8" class="form-horizontal ajax_form edit" enctype="multipart/form-data">
                            @method('PATCH')
                            @csrf

                            @include ('_admin.cvs.form', ['submitButtonText' => 'Update'])
