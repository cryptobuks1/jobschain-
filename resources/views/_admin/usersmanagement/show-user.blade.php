    ...
    <div class="row">
        <div class="col-xs-12">
          ...
          <div class="panel-heading">
            <a href="{{URL::to('/admin/users/')}}" class="btn btn-primary btn-xs pull-right">
          ...
          <div class="panel-body">
            ...
            <div class="well">
              <div class="row">
                <div class="col-sm-6">
                  <img src="@if ($user->profile && $user->profile->avatar_status == 1) {{ $user->profile->avatar }} @else {{ Gravatar::get($user->email) }} @endif" width="200px" alt="{{ $user->name }}" id="" class="img-circle center-block margin-bottom-2 margin-top-1 user-image">
                </div>
                ...
                <div class="col-sm-6">
                  ...
                  @if ($user->profile)
                    <div class="text-center text-left-tablet margin-bottom-1">
                      ...
                      <table class="table">
						  <tr>
							  <td ><a href="{{ url('/profile/'.$user->name) }}" class="btn btn-sm btn-info">
							 ...
							 <td> <a href="{{URL::to('/admin/users/'.$user->id.'/edit')}}" class="btn btn-sm btn-warning">
							  ...
							  <td>{!! Form::open(array('url' => 'admin/users/' . $user->id, 'class' => 'form-inline')) !!}
