...
@section('title')
{!! __("admin.Create")  !!} {!! __("admin.New")  !!} Job
@endsection
@push('css') 
...
@section('content_header')
     <h1>
       {!! __("admin.Create")  !!} {!! __("admin.New")  !!}  {!! trans("jobs.Job")  !!}  #
        <small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> {!! __("admin.dashboard")  !!}</a></li>
        <li class="active">{!! __("admin.Create")  !!} {!! __("admin.New")  !!}  {!! trans("jobs.Job")  !!}  #</li>
    </ol>
@endsection
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box-header with-border">
              <h3 class="box-title"> <a href="{{ route('admin.jobs.index') }}" title="Back"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button></a>&nbsp;&nbsp; {!! __("admin.Create")  !!} {!! __("admin.New")  !!}  {!! trans("jobs.Job")  !!}  #</h3>
            </div>
			...
			<div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.jobs.store') }}" accept-charset="UTF-8" class="form-horizontal ajax_form" enctype="multipart/form-data">
                            @csrf
							@include ('_admin.jobs.form')
                        </form>
