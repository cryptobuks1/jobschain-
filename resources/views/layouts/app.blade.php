...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/custom.css"> @stack('css') {!!config('tracking.header_code')!!}
    <style>
        @stack('styles')
    </style>
</head>
                        ...
                        <div class="row align-items-center">
                            <div class="col-2">
                                <h2 class="mb-0 site-logo">
                                    <a href="/"><img class="img-h-40" src="/assets/images/Jobit.png" /></a>
                                </h2>
                            </div>
                            <div class="col-10">
                                    ...
                                    <div class="container">
                                        ...
                                        <ul class="site-menu js-clone-nav d-none d-lg-block">
                                            <li class="has-children">
                                                <a href="#">{{__('app.for_candidates')}}</a>
                                                <ul class="dropdown arrow-top">
                                                    <li><a href="{{ route('jobs.index') }}">{{__('app.browse_jobs')}}</a>
                                                    </li>
                                                    <li><a href="{{ route('cvs.create') }}">{{__('app.post_a_cv')}}</a>
                                                    </li>

                                                </ul>
                                            </li>
                                            <li class="has-children">
                                                <a href="#">{{__('app.for_employers')}}</a>
                                                <ul class="dropdown arrow-top">
                                                    <li><a href="{{route('candidates.index')}}">{{__('app.browse_candidates')}}</a>
                                                    </li>
