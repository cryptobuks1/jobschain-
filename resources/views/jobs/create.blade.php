  ...
  <div class="container">
    <div class="row"> 
      <div class="col-md-12 col-lg-8 mb-5">
          ...
          <div class="row form-group">
            <div class="col-md-12 mb-3 mb-md-0">
              ...
              <select name="country" id="country" class="form-control" placeholder="Select Country" required>
                ...
                <option value="{{ $country->iso_3166_3 }}">{{ $country->name }}</option>
                @endforeach
              </select>
            </div>
          </div>
        ...
        <div class="row form-group">
            <div class="col-md-12"><label class="font-weight-bold" for="title">Qualifications</label></div>
            <div class="col-md-12 mb-3 mb-md-0">
              <textarea name="qualifications" class="form-control" cols="30" rows="5" required></textarea>
            </div>
          </div>
        <div class="row form-group">
            <div class="col-md-12"><label class="font-weight-bold" for="title">Description</label></div>
            <div class="col-md-12 mb-3 mb-md-0">
