...
<div class="row">
    <div class="col-md-12">
        <ul class="statistics margin-top-45 hide-under-992px">
            <li> <strong class="counter">3,586</strong> <span>{{app.jobs_posted}}</span> </li>
                ...
                <div class="rounded border jobs-wrap">
                    ...
                    <a href="{{route('jobs.show',$job->id)}}" class="job-item d-block d-md-flex align-items-center  border-bottom fulltime">
                        <div class="company-logo blank-logo text-center text-md-left pl-3"> @if(empty($job->company->logo))
                            <span class="btn btn-icon btn-soft-secondary rounded-circle"><span class="btn-icon__inner text-dark">Tx</span> @else
                        ...
                        <div class="job-category align-self-center">
                            <div class="p-3"> <span class="text-info p-2 rounded border border-info">{{$job->type}}</span> </div>
                        </div>
                    </a>
                    @endforeach
                </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 mb-3" data-aos="fade-up" data-aos-delay="100">
                <a href="#" class="h-100 feature-item"> <span class="d-block icon flaticon-calculator mb-3 text-primary"></span>
                    <h2>{{$cat->name}}</h2>
                    <span class="counting">{{$cat->jobs->count()}}</span></a>
            </div>
            @endforeach
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="d-block d-md-flex row border-bottom">
            ...
            <div class="text-center p-4 item col-md-6" data-aos="fade">
                <span class="flaticon-wrench display-3 mb-3 d-block text-primary col-md-6"></span>
