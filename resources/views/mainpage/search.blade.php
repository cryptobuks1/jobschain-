                ...
                <div class="card-body px-sm-4 pb-sm-4 ">
                    <form action="/search" method="GET" autocomplete="off" spellcheck="false">
                        ...
                        <div class="input-group input-group-main">
                            <input id="search" type="text" value="{{$keyword ?? ''}}" class="form-control py-3 mb-0" placeholder="Enter / Txhash / Block Hash / Address" name="q">
                            <div class="input-group-append">
                                <button class="btn btn-primary" type="submit"> <i class="fa fa-search d-inline-block d-sm-none"></i><span class="d-none d-sm-inline-block"><i class="fa fa-search"></i> Search</span> </button>
                            </div>
                        </div>
                    </form>
                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control form-control-sm" type="text" value="{{$job->category}}" readonly>
                                                    </div>
                                                </div><!-- .col -->
                                                 <div class="col-md-6">
                                                    <div class="form-group">
