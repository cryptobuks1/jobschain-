<template>
	<div>
		...
		<div v-if="ready && !balance.id">
			<div class="page-header page-header-kyc">
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-lg-8 col-xl-7 text-center">
							<h2 class="page-title">{{$t('wallet.setup_wallet')}}</h2>
							<p class="large">{{$t('wallet.setup_text')}}</p>
						</div>
					</div>
				</div><!-- .container -->
			</div><!-- .page-header -->
                    ...
                    <div class="kyc-status card mx-lg-4">
                        <div class="card-innr">
                            <div class="status status-thank px-md-5">
                                ...
                                <span class="status-text large text-dark">{{$t('wallet.use_strong_password')}}</span>
                                <p v-if="setuperror.length < 1" class="px-md-5">{{$t('wallet.use_strong_password_text')}}.
								</p>
								<p v-else class="px-md-5 text-danger"> {{setuperror}} </p>
								<div class="row d-flex justify-content-center">
									<div class="col-md-6">
										<div class="input-item input-with-label">
											<label for="wallet" class="input-item-label">{{$t("wallet.password")}} </label>
											<div class="input-wrap">
											<input class="input-bordered" type="password" id="address" name="amount" v-model="set_password" >	
											</div>
										</div>
										<!-- .input-item --> 
									</div>
                                ...
                                <a href="#" @click.prevent="setup_wallet()" class="btn btn-primary">{{$t('wallet.setup_wallet')}}</a>
                            </div>
                        </div>
                    </div><!-- .card -->
                    <p class="text-light text-center mgmt-1x">{{$t('wallet.contact_support')}}</p>
                    <div class="gaps-1x"></div>
                    <div class="gaps-3x d-none d-sm-block"></div>
                </div>
            </div>
		</div>
		<div v-if="ready && balance.id > 0">
			<div class="row">
							...
							<div class="row">
								<div class="col-md-8">
									<div class="copy-wrap mgb-0-5x">
										<span class="copy-feedback"></span><em class="fab fa-bitcoin"></em>
				...
				<div class="modal-dialog modal-dialog-md modal-dialog-centered">
					<div class="modal-content"><a href="#" class="modal-close" data-dismiss="modal" aria-label="Close"><em class="ti ti-close"></em></a>
						<div class="popup-body">
							<h4 class="popup-title">{{$t('wallet.withdraw',{symbol:balance.text})}}</h4>
			...
			<div class="modal fade" id="pv-modal" tabindex="-1">
				<div class="modal-dialog modal-dialog-md modal-dialog-centered">
					<div class="modal-content"><a href="#" class="modal-close" data-dismiss="modal" aria-label="Close"><em class="ti ti-close"></em></a>
						<div class="popup-body">
							<h4 class="popup-title">Mnemonic (Xpriv)</h4>
